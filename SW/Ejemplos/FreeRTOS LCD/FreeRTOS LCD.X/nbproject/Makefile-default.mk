...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/FreeRTOS_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/main.o "${OBJECTDIR}/_ext/1725264358/Driver LCD.o" ${OBJECTDIR}/_ext/1386115845/heap_2.o ${OBJECTDIR}/_ext/1147412712/list.o ${OBJECTDIR}/_ext/843873358/port.o ${OBJECTDIR}/_ext/843873358/port_asm.o ${OBJECTDIR}/_ext/1147412712/queue.o ${OBJECTDIR}/_ext/1147412712/tasks.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/main.o.d "${OBJECTDIR}/_ext/1725264358/Driver LCD.o.d" ${OBJECTDIR}/_ext/1386115845/heap_2.o.d ${OBJECTDIR}/_ext/1147412712/list.o.d ${OBJECTDIR}/_ext/843873358/port.o.d ${OBJECTDIR}/_ext/843873358/port_asm.o.d ${OBJECTDIR}/_ext/1147412712/queue.o.d ${OBJECTDIR}/_ext/1147412712/tasks.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/1725264358/Driver\ LCD.o ${OBJECTDIR}/_ext/1386115845/heap_2.o ${OBJECTDIR}/_ext/1147412712/list.o ${OBJECTDIR}/_ext/843873358/port.o ${OBJECTDIR}/_ext/843873358/port_asm.o ${OBJECTDIR}/_ext/1147412712/queue.o ${OBJECTDIR}/_ext/1147412712/tasks.o
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/FreeRTOS_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1472/main.o: ../main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/main.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DMPLAB_PIC32MX_PORT -I"../../Drivers FreeRTOS Micros-Designs/include" -I"../../../Microchip/Include" -I"../../Microchip/Include" -I"../../../../include" -I"../../../include" -I"../../include" -I".." -I"../../FreeRTOS/Source/include" -I"../../FreeRTOS/Source/portable/MPLAB/PIC32MX" -fomit-frame-pointer -MMD -MF "${OBJECTDIR}/_ext/1472/main.o.d" -o ${OBJECTDIR}/_ext/1472/main.o ../main.c  
	
${OBJECTDIR}/_ext/1725264358/Driver\ LCD.o: ../../Drivers\ FreeRTOS\ Micros-Designs/source/Driver\ LCD.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1725264358 
	@${RM} ${OBJECTDIR}/_ext/1725264358/Driver\ LCD.o.d 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1725264358/Driver LCD.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DMPLAB_PIC32MX_PORT -I"../../Drivers FreeRTOS Micros-Designs/include" -I"../../../Microchip/Include" -I"../../Microchip/Include" -I"../../../../include" -I"../../../include" -I"../../include" -I".." -I"../../FreeRTOS/Source/include" -I"../../FreeRTOS/Source/portable/MPLAB/PIC32MX" -fomit-frame-pointer -MMD -MF "${OBJECTDIR}/_ext/1725264358/Driver LCD.o.d" -o "${OBJECTDIR}/_ext/1725264358/Driver LCD.o" "../../Drivers FreeRTOS Micros-Designs/source/Driver LCD.c"  
...
${OBJECTDIR}/_ext/1472/main.o: ../main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/main.o.d 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/main.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DMPLAB_PIC32MX_PORT -I"../../Drivers FreeRTOS Micros-Designs/include" -I"../../../Microchip/Include" -I"../../Microchip/Include" -I"../../../../include" -I"../../../include" -I"../../include" -I".." -I"../../FreeRTOS/Source/include" -I"../../FreeRTOS/Source/portable/MPLAB/PIC32MX" -fomit-frame-pointer -MMD -MF "${OBJECTDIR}/_ext/1472/main.o.d" -o ${OBJECTDIR}/_ext/1472/main.o ../main.c  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/FreeRTOS_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)    -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/FreeRTOS_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}       -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=_min_heap_size=0,-L"..",-Map="${DISTDIR}/FreeRTOS_LCD.X.${IMAGE_TYPE}.map",-O3 
else
dist/${CND_CONF}/${IMAGE_TYPE}/FreeRTOS_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/FreeRTOS_LCD.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}       -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=0,-L"..",-Map="${DISTDIR}/FreeRTOS_LCD.X.${IMAGE_TYPE}.map",-O3
	${MP_CC_DIR}\\pic32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/FreeRTOS_LCD.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  
endif
