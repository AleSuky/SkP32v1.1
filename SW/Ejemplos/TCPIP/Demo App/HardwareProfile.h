...
// LEDs
#define LED0_TRIS			(TRISBbits.TRISB8)	// Ref LED1
#define LED0_IO				(LATBbits.LATB8)
#define LED1_TRIS			(TRISBbits.TRISB9)	// Ref LED2
#define LED1_IO				(LATBbits.LATB9)
#define LED2_TRIS			(TRISBbits.TRISB10)	// Ref LED3
#define LED2_IO				(LATBbits.LATB10)
#define LED3_TRIS			(TRISBbits.TRISB11)	// Ref LED4
#define LED3_IO				(LATBbits.LATB11)
#define LED4_TRIS			(TRISBbits.TRISB11)			// No such LED
#define LED4_IO				(LATBbits.LATB11)
#define LED5_TRIS			(TRISBbits.TRISB11)			// No such LED
#define LED5_IO				(LATBbits.LATB11)
#define LED6_TRIS			(TRISBbits.TRISB11)			// No such LED
#define LED6_IO				(LATBbits.LATB11)
#define LED7_TRIS			(TRISBbits.TRISB11)			// No such LED
#define LED7_IO				(LATBbits.LATB11)
#define LED_GET()			((PORTB & 0x0F00)>>8)
#define LED_PUT(a)			do{LATB = (LATB & 0xF0FF) | ((unsigned int)((a)&0x0F)<<8);}while(0)
...
#define BUTTON2_TRIS		(TRISBbits.TRISB13)	// No BUTTON
#define BUTTON2_IO			(1)
#define BUTTON3_TRIS		(TRISBbits.TRISB13)	// No BUTTON
#define BUTTON3_IO			(1)
...
// ENC28J60 I/O pins
	...
	#define ENC_CS_TRIS			(TRISBbits.TRISB4)
	#define ENC_CS_IO			(PORTBbits.RB4)
	//#define ENC_RST_TRIS		(TRISBbits.TRISB5)	// Not connected by default.  It is okay to leave this pin completely unconnected, in which case this macro should simply be left undefined.
