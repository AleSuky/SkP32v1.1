...
#include <plib.h>
	...
	void putrsUART(const char *Ptr);
	void putsUART(char *Ptr);
	#define BusyUART()		!UARTTransmitterIsReady(UART2)
	#define WriteUART(a)	UARTSendDataByte(UART2, a)
	#define ReadUART()		UARTGetDataByte(UART2)
	#define DataRdyUART()	!UARTReceivedDataIsAvailable(UART2)
#endif
