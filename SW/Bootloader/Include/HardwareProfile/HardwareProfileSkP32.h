 ...
 *----------------------------------------------------------------------------* */
#ifndef _HARDWARE_PROFILE_SKP32_H_
#define _HARDWARE_PROFILE_SKP32_H_
...
#define ReadSwitchStatus() 	SW1_STATUS()
  // Error indication.	
#define Error()   do{LATBbits.LATB8 = 1; LATBbits.LATB9 = 1;} while(0);
